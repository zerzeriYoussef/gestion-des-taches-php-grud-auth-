...
if(isset($_POST['resetPassword']) ){
    ...
    $mail->Body = '
        ...
        <br>
        ' . '<a href="http://localhost:3000/reset.php?email='.$_POST['email']. 
        '&code='.$user->SECURITY_CODE. '">http://localhost:3000/reset.php?email='.$_POST['email']. 
        '&code='.$user->SECURITY_CODE.'</a>';
        ;
        
        $mail->setFrom("youssefzerzeri34@gmail.com", "youssef zerzeri");
          $mail->send();
        echo '
...
if(isset($_POST['newPassword'])){
   /* $username = "root";
    $password = "";
    $database = new PDO("mysql:host=localhost; dbname=zerzri;",$username,$password);*/
